...
You can install the development version of tidygam from [GitHub](https://github.com/) with:
...
For examples, see the documentation of `predict_gam()` and `plot.tidygam()`.
